...
Partial Public Class Transaction
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Transaction_ItemSale", Storage:="_ItemSales", ThisKey:="transactionID", OtherKey:="transactionID")>  _
...
Partial Public Class ItemSale
    ...
    Partial Private Sub OnCreated()
    End Sub
    Partial Private Sub OnitemSaleIDChanging(value As String)
    End Sub
    Partial Private Sub OnitemSaleIDChanged()
    End Sub
    Partial Private Sub OntransactionIDChanging(value As String)
    End Sub
    Partial Private Sub OntransactionIDChanged()
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_itemSaleID", DbType:="VarChar(10) NOT NULL", CanBeNull:=false, IsPrimaryKey:=true)>  _
	Public Property itemSaleID() As String
		Get
			Return Me._itemSaleID
		End Get
		Set
			If (String.Equals(Me._itemSaleID, value) = false) Then
				Me.OnitemSaleIDChanging(value)
				Me.SendPropertyChanging
				Me._itemSaleID = value
				Me.SendPropertyChanged("itemSaleID")
				Me.OnitemSaleIDChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_transactionID", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	Public Property transactionID() As String
		Get
			Return Me._transactionID
		End Get
